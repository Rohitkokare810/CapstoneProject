...
insert into admin values('rohit@gmail.com','admin@123')
select * from admin

create table Employee(EmpId nvarchar(50) primary key,Name nvarchar(50), DOJ date,Passcode int)
insert into Employee values('Emp1@gmail.com','Nikhil','2023-02-20',11)
...
insert into BlogInfo values(101,'Life Of Animal','Forest','2023-03-20','www.google.com','Emp1@gmail.com')
